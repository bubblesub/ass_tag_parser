...
class NodeVisitor(parsimonious.NodeVisitor):
    ...
    def visit_ass_chunk(self, _node, visited_nodes):
        return {
            'type': 'tags',
    ...
    def visit_ass_tag_italics(self, _node, visited_nodes):
        return {'type': 'italics', 'enabled': visited_nodes[1]}

    def visit_ass_tag_bold(self, _node, visited_nodes):
        if isinstance(visited_nodes[1][0], bool):
            return {'type': 'bold', 'enabled': visited_nodes[1][0]}
        return {'type': 'bold', 'weight': visited_nodes[1][0]}

    def visit_ass_tag_underline(self, _node, visited_nodes):
        return {'type': 'underline', 'enabled': visited_nodes[1]}

    def visit_ass_tag_strikeout(self, _node, visited_nodes):
        return {'type': 'strikeout', 'enabled': visited_nodes[1]}

    def visit_ass_tag_border(self, _node, visited_nodes):
        return {'type': 'border', 'size': visited_nodes[1]}

    def visit_ass_tag_border_x(self, _node, visited_nodes):
        return {'type': 'border-x', 'size': visited_nodes[1]}

    def visit_ass_tag_border_y(self, _node, visited_nodes):
        return {'type': 'border-y', 'size': visited_nodes[1]}

    def visit_ass_tag_shadow(self, _node, visited_nodes):
        return {'type': 'shadow', 'size': visited_nodes[1]}

    def visit_ass_tag_shadow_x(self, _node, visited_nodes):
        return {'type': 'shadow-x', 'size': visited_nodes[1]}

    def visit_ass_tag_shadow_y(self, _node, visited_nodes):
        return {'type': 'shadow-y', 'size': visited_nodes[1]}

    def visit_ass_tag_blur_edges(self, _node, visited_nodes):
        return {'type': 'blur-edges', 'value': visited_nodes[1]}

    def visit_ass_tag_blur_edges_gauss(self, _node, visited_nodes):
        return {'type': 'blur-edges-gauss', 'value': visited_nodes[1]}

    def visit_ass_tag_font_name(self, _node, visited_nodes):
        return {'type': 'font-name', 'name': visited_nodes[0][1]}

    def visit_ass_tag_font_encoding(self, _node, visited_nodes):
        return {'type': 'font-encoding', 'encoding': visited_nodes[1]}

    def visit_ass_tag_font_size(self, _node, visited_nodes):
        return {'type': 'font-size', 'size': visited_nodes[1]}

    def visit_ass_tag_font_scale_x(self, _node, visited_nodes):
        return {'type': 'font-scale-x', 'scale': visited_nodes[1]}

    def visit_ass_tag_font_scale_y(self, _node, visited_nodes):
        return {'type': 'font-scale-y', 'scale': visited_nodes[1]}

    def visit_ass_tag_letter_spacing(self, _node, visited_nodes):
        return {'type': 'letter-spacing', 'value': visited_nodes[1]}

    def visit_ass_tag_rotation_x(self, _node, visited_nodes):
        return {'type': 'rotation-x', 'angle': visited_nodes[1]}

    def visit_ass_tag_rotation_y(self, _node, visited_nodes):
        return {'type': 'rotation-y', 'angle': visited_nodes[1]}

    def visit_ass_tag_rotation_z(self, _node, visited_nodes):
        return {'type': 'rotation-z', 'angle': visited_nodes[0][1]}

    def visit_ass_tag_rotation_origin(self, _node, visited_nodes):
        return {
    ...
    def visit_ass_tag_shear_x(self, _node, visited_nodes):
        return {'type': 'shear-x', 'value': visited_nodes[1]}

    def visit_ass_tag_shear_y(self, _node, visited_nodes):
        return {'type': 'shear-y', 'value': visited_nodes[1]}

    def visit_ass_tag_color_primary(self, _node, visited_nodes):
        return {
            'type': 'color-primary',
    ...
    def visit_ass_tag_color_secondary(self, _node, visited_nodes):
        return {
    ...
    def visit_ass_tag_color_border(self, _node, visited_nodes):
        return {
            'type': 'color-border',
            'red': visited_nodes[1][2],
            'green': visited_nodes[1][1],
    ...
    def visit_ass_tag_color_shadow(self, _node, visited_nodes):
        return {
            'type': 'color-shadow',
            'red': visited_nodes[1][2],
            'green': visited_nodes[1][1],
    ...
    def visit_ass_tag_alpha_all(self, _node, visited_nodes):
        return {'type': 'alpha-all', 'value': visited_nodes[1]}

    def visit_ass_tag_alpha_primary(self, _node, visited_nodes):
        return {'type': 'alpha-primary', 'value': visited_nodes[1]}

    def visit_ass_tag_alpha_secondary(self, _node, visited_nodes):
        return {'type': 'alpha-secondary', 'value': visited_nodes[1]}

    def visit_ass_tag_alpha_border(self, _node, visited_nodes):
        return {'type': 'alpha-border', 'value': visited_nodes[1]}

    def visit_ass_tag_alpha_shadow(self, _node, visited_nodes):
        return {'type': 'alpha-shadow', 'value': visited_nodes[1]}

    def visit_ass_tag_karaoke_1(self, _node, visited_nodes):
        return {'type': 'karaoke-1', 'duration': visited_nodes[1] * 10}

    def visit_ass_tag_karaoke_2(self, _node, visited_nodes):
        return {'type': 'karaoke-2', 'duration': visited_nodes[1] * 10}

    def visit_ass_tag_karaoke_3(self, _node, visited_nodes):
        return {'type': 'karaoke-3', 'duration': visited_nodes[1] * 10}

    def visit_ass_tag_karaoke_4(self, _node, visited_nodes):
        return {'type': 'karaoke-4', 'duration': visited_nodes[1] * 10}

    def visit_ass_tag_alignment(self, _node, visited_nodes):
    ...
    def visit_ass_tag_alignment_legacy(self, _node, visited_nodes):
        value = visited_nodes[1]
        if value in (1, 2, 3):
            pass
        elif value in (5, 6, 7):
    ...
    def visit_ass_tag_reset_style(self, _node, visited_nodes):
        return {
            'type': 'reset-style',
            'style': visited_nodes[1][0] if visited_nodes[1] else None,
        }

    def visit_ass_tag_position(self, _node, visited_nodes):
        return {
            'type': 'position',
            'x': visited_nodes[1],
            'y': visited_nodes[3],
    ...
    def visit_ass_tag_movement(self, _node, visited_nodes):
        return {
            'type': 'movement',
            'x1': visited_nodes[1],
            'y1': visited_nodes[3],
    ...
    def visit_ass_tag_fade_simple(self, _node, visited_nodes):
        return {
            'type': 'fade-simple',
    ...
    def visit_ass_tag_fade_complex(self, _node, visited_nodes):
        return {
            'type': 'fade-complex',
    ...
    def visit_ass_tag_animation(self, _node, visited_nodes):
        return {
            'type': 'animation',
    ...
    def visit_ass_tag_drawing_mode(self, _node, visited_nodes):
        return {'type': 'drawing-mode', 'value': visited_nodes[1]}

    def visit_ass_tag_baseline_offset(self, _node, visited_nodes):
